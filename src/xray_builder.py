...
def build_happ_profiles(
    ...
    *,
    ...
    3) Мобильный Интернет #N — обход из основного ключа (если есть)
    4) Мобильный Интернет #N 🔥/⚡ — только обход из VPN_BYPASS_SOURCE_URL / _2
       (страны из этих ключей не подмешиваются)
    """
